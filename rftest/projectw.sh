...
RF_HOME=/home/projectw/RouteFlow
RFSERVERCONFIG=/tmp/rfserverconfig.csv
RFSERVERINTERNAL=/tmp/rfserverinternal.csv
HOME_RFSERVERCONFIG="/home/projectw/"`basename $RFSERVERCONFIG`
HOME_RFSERVERINTERNAL="/home/projectw/"`basename $RFSERVERINTERNAL`
...
if [ "$ACTION" != "RESET" ]; then
    ...
    ./rfserver/rfserver.py $RFSERVERCONFIG -i $RFSERVERINTERNAL &
